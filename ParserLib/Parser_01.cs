				...
				switch(statTk)
				{
					...
					case Token.TkStat.Operatore:					// Se sta leggendo un operatore...
					{
						...
						{											// La stringa attuale + il carattere operatore...
							if(operatori.Contains(strTkAttuale.ToString()+ch.ToString(),Operators.TipoOp.Operatore))		// ...è ancora un operatore valido ?							{
							{																		
							...
							{														// Se no, controlla la stringa attuale da sola.
								if(operatori.Contains(strTkAttuale.ToString(),Operators.TipoOp.Operatore))		// Se è un operatore, lo memorizza...			
						...
						{											// Carattere non di operatore:...
							if(operatori.Contains(strTkAttuale.ToString(),Operators.TipoOp.Operatore))		// Se la stringa attuale è un operatore, lo memorizza
							{
								statTkNew = Token.TkStat.TokenCompletato;
								tkAttuale = new Token(Token.TipoTk.Operatore,strTkAttuale.ToString());
							}
